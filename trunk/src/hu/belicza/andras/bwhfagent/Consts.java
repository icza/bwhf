...
public class Consts {
	...
	static {
		...
		DEFAULT_SETTINGS_PROPERTIES.setProperty( PROPERTY_WINDOW_POSITION               , "5,10,1010,830" );
		...
		DEFAULT_SETTINGS_PROPERTIES.setProperty( PROPERTY_MATCHING_PROBABILITY_TRESHOLD , "2" );

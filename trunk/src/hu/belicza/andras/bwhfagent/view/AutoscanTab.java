			...
			public void run() {
				...
				while ( true ) {
					try {
						...
						if ( newLastReplayLastModified != lastModifiedOfLastChecked && newLastReplayLastModified > 0l ) {
							...
							if ( autoscanEnabledTime != null && newLastReplayLastModified >= autoscanEnabledTime.getTime() ) {
								...
								final Replay replay = BinRepParser.parseReplay( lastReplayFile, true, false, true, false );
								if ( replay != null )
